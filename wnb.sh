...
# Define the script path for the new shortcut (Alt + W)
RUN_SCRIPT_PATH="$(realpath waf.sh)"
...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:$CUSTOM_PATH name "WAF"
